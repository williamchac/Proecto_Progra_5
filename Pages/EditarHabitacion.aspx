<%@ Page Title="Editar Habitación" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarHabitacion.aspx.cs" Inherits="ProyectoFinalP5.Pages.EditarHabitacion" %>
    ...
    <div class="form-panel">
        <div class="row g-3">
            ...
            <div class="col-12 text-end mt-4">
                ...
                <asp:Button ID="btnInactivar" runat="server" Text="Inactivar Habitación" 
                            CssClass="btn btn-inactivar me-2" OnClick="btnInactivar_Click" 
                            OnClientClick="return confirm('¿Está seguro que desea inactivar esta habitación?');" 
