<%@ Page Title="Gestionar Reservaciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionarReservaciones.aspx.cs" Inherits="ProyectoFinalP5.Pages.GestionarReservaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .estado-proceso { background-color: #28a745; color: white; }
        .estado-espera { background-color: #0071c2; color: white; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="page-title">
                <i class="fas fa-tasks me-2"></i>Gestionar Reservaciones
            </h2>
        </div>
    ...
    <div class="filtro-panel">
        <h5 class="mb-3"><i class="fas fa-filter me-2"></i>Filtrar Reservaciones</h5>
        <div class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                <label for="txtFechaEntrada" class="form-label">Fecha Entrada <span class="text-danger">*</span></label>
            ...
            <div class="col-md-3">
                <label for="txtFechaSalida" class="form-label">Fecha Salida <span class="text-danger">*</span></label>
            ...
            <div class="col-md-2 d-flex align-items-end">
                <asp:Button ID="btnFiltrar" runat="server" Text="Filtrar" 
                            CssClass="btn btn-filtrar w-100" 
    ...
    <div class="table-responsive">
        <asp:GridView ID="gvReservaciones" runat="server" CssClass="table table-zebra mb-0" 
                      AutoGenerateColumns="False" EmptyDataText="No hay reservaciones que coincidan con los criterios de búsqueda."
